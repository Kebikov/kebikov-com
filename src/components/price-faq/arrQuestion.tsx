...
export const arrQuestion: IItemQuestion[] = [
    {
        case: (<>СКОЛЬКО СТОИТ <NoWrap>СВАДЕБНАЯ ФОТОСЕССИЯ ?</NoWrap></>),
    ...
    {
        case: (<>СНИМАЕТЕ ЛИ ВЫ СВАДЕБНЫЕ ФОТОСЕССИИ <NoWrap>В ДРУГИХ ГОРОДАХ ?</NoWrap></>),
        answer: 'Да, я снимаю свадьбы в любом месте.'
    },
    {
        case: (<>КАКОЕ КОЛИЧЕСТВО СВАДЕБНЫХ ФОТОГРАФИЙ<NoWrap> МЫ ПОЛУЧИМ ?</NoWrap></>),
    ...
    {
        case: (<>КОГДА МЫ ПОЛУЧИМ <NoWrap>СВАДЕБНЫЕ ФОТОГРАФИИ ?</NoWrap></>),
    ...
    {
        case: (<>СКОЛЬКО ФОТОГРАФИЙ <NoWrap>БУДЕТ ОБРАБОТАНО ?</NoWrap></>),
    ...
    {
        case: (<>КАК ЗАБРОНИРОВАТЬ <NoWrap>ДАТУ СВАДЬБЫ ?</NoWrap></>),
