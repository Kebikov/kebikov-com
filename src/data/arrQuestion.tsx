...
export const arrQuestion: IItemQuestion[] = [
    {
        ...
        answer: <>`Вы можете выбрать один из четырех пакетов свадебной фотосессии, или мы с вами вместе сформируем ваш индивидуальный комплекс услуг, убрав или добавив пункты по желанию. Спектр цен  гибко подстраивается под практически любой свадебный бюджет. 
    ...
    {
        case: <>'КОГДА МЫ ПОЛУЧИМ <a href='/' className='ancor' style={{color: 'var(--color-gold)'}} >СВАДЕБНЫЕ ФОТОГРАФИИ</a> ?'</>,
